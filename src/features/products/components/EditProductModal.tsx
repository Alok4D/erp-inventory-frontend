    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl relative animate-in fade-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="pt-2">
            <label className="block text-sm font-medium text-gray-700 mb-1.5">Update Image (Optional)</label>
            ...
            <p className="text-xs text-gray-500 mt-2">Leave blank to keep the existing image.</p>
          </div>
