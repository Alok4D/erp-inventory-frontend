...
export function DeleteSaleModal({ onClose, onConfirm, isLoading }: DeleteSaleModalProps) {
  return (
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md relative animate-in fade-in zoom-in-95 duration-200">
        <div className="flex justify-between items-center p-6 border-b border-gray-100">
          <div className="flex items-center space-x-2 text-red-600">
            ...
            <h2 className="text-xl font-semibold text-gray-900">Delete Sale Record</h2>
          </div>
          <button 
            onClick={onClose}
            disabled={isLoading}
        ...
        <div className="p-6">
          <p className="text-gray-600">Are you sure you want to delete this sale? The products from this sale will be returned to stock. This action cannot be undone.</p>
